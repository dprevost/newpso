...
//   psocInitErrorHandler( &pSession->context.errorHandler );
   ...
   pSession->context.pBaseAddress = (unsigned char *) pSession->pHeader;
   GET_PTR(pSession->context.pBaseAddress, pSession->context.pAllocator, pSession->pHeader->allocatorOffset, void );
