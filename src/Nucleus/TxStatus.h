...
static inline 
void psonTxStatusInit( psonTxStatus       * pStatus,
                       ptrdiff_t            txOffset,
                       psonSessionContext * pContext )
{
...
static inline
void psonTxStatusSetTx( psonTxStatus      * pStatus,
                        ptrdiff_t           txOffset,
                       psonSessionContext * pContext )
{
   PSO_PRE_CONDITION( pStatus != NULL );
...
static inline
bool psonTxStatusIsValid( psonTxStatus       * pStatus,
                          ptrdiff_t            txOffset,
                          psonSessionContext * pContext )
{
   bool rc = false;
                                      ...
                                      psonSessionContext * pContext )
{
   ...
   rc = pStatus->status & PSON_TXS_DESTROYED;
                                    ...
                                    psonSessionContext * pContext )
{
   ...
   rc = pStatus->status & PSON_TXS_DESTROYED_COMMITTED;
...
static inline
psoErrors psonTxTestObjectStatus( psonTxStatus       * pStatus,
                                  ptrdiff_t            txOffset,
                                  psonSessionContext * pContext )
{
   PSO_PRE_CONDITION( pStatus != NULL );
